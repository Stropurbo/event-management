...
from tasks.views import home, create_event, create_category,delete_cat,delete_participant,rsvp_event, show_cat,create_participate,update_event,dashboard,delete_event,event_details,event_details_view
